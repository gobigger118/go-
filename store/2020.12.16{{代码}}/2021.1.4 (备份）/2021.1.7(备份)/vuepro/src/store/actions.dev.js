...
var _default = {
  ...
  getUserInfo: function getUserInfo(commit) {
    var rs;
    return regeneratorRuntime.async(function getUserInfo$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return regeneratorRuntime.awrap((0, _getDate.getUser)());
